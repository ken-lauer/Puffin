...
def binPhase(eDB):
    ...
    DataBinningAtts.reductionOperator = (
        DataBinningAtts.Sum
    )  # Average, Minimum, Maximum, StandardDeviation, Variance, Sum, Count, RMS, PDF
    DataBinningAtts.varForReduction = "electrons_chargeSI"
    DataBinningAtts.emptyVal = 0
    DataBinningAtts.outputType = (
        DataBinningAtts.OutputOnBins
    ...
    PseudocolorAtts.opacityType = (
        PseudocolorAtts.Ramp
